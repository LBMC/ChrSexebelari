...
% -----------------------------------------------------
\subsection{Raw variants calling with samtools mpileup} 
...
\begin{tabular}{c|c|c|c|c} 
 & male & female \\
 \hline
SNPs & 648,864 & 815,270 \\
Insertions & 54,445 & 80,454\\
Deletions & 32,446 & 42,138\\
MNPs & 0 & 0 \\
het/hom ratio (total / SNPs / Insertions / Deletions) & 3.4 / 3.87 / 1.5 / 1.6 & 8.77 / 11.75 / 2.61 / 3.32 \\
Insertions/Deletions ratio & 1.68 & 1.91 \\
SNP Transitions/Transversions & 1.45 & 1.44 \\
\end{tabular}
