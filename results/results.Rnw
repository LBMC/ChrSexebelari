...
\begin{enumerate}
  \item \textbf{make and hybrid reference of M. belari and E. coli 0P50 genomes}: I created an hybrid reference as a single fasta file, saved as \texttt{data/ReferenceGenomes/combined\_belari\_coli.fasta.gz}. I will map each pool against this reference.\\
...
\begin{itemize}
 \item Produce bedpe files: \textcolor{red}{bamtobedpe\_Mbelari.sh}\\
  \item Produce bed files with depth at each bp: \textcolor{red}{sort\_Mbelari.sh} \textcolor{red}{bamtobed\_Mbelari.sh}\\
...
\hline
MRDR5 (female) & 2,273 & 497 & 22.9 \\
 \hline 
MRDR6 (male) & 1,349 & 295 & 13.6\\
\end{tabular}
\end{small}
...
Coverage values were first normalized  by dividing median coverage value in each sample.

\includegraphics{{./coverage/2017_09_14_norm_by_med_coverage_per_contig}.pdf}

\includegraphics{{./coverage/2017_09_14_pos_norm_coverage_contigMBELA.09799}.pdf}
...
For the others toolboxes sused, see in script the versions used.


% --------------------------------------------
\subsection{Sort BAM files to call variants on} 
...
\begin{tabular}{c|c|c|c|c}
female against belari / after rmdup &  male against belari / after rmdup & description\\
\hline
37,074,990 / 35,389,848 &  22,004,523 / 20,066,441 & mapped \\
34,427,332 (92.86\%) / 32,744,676 (92.53\%) & 20,238,012 (91.97\%) / 18,301,958 (91.21\%) &  properly paired\\
\hline
\end{tabular}


% -----------------------------
\subsection{Add RG information} 
...
% --------------------------
\subsection{Index input BAM} 

\textcolor{blue}{sort\_Mbelari.sh}\\


% --------------------------------------------------
\subsection{Realignment around INDELs using GATK}
...
\begin{tabular}{c|c|c|c|c} 
 & male & female \\
 \hline
SNPs & 653,292 & 943,379 \\
Insertions & 55,379 & 81,318\\
Deletions & 32,949 & 42,555\\
MNPs & 0 & 0 \\
het/hom ratio (total / SNPs / Insertions / Deletions) & 3.4 / 3.88 / 1.5 / 1.6 & 8.75 / 11.76 / 2.59 / 3.32 \\
Insertions/Deletions ratio & 1.68 & 1.91 \\
SNP Transitions/Transversions & 1.45 & 1.43 \\
\end{tabular}
