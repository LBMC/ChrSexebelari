...
bedtools sort -faidx ~/Documents/stage_mbelari/results/coverage_analysis/2018-06-21-Mbelari_hybrid_genome_sizes.txt -i ~/Documents/stage_mbelari/results/duplications/2018-07-26-Blast_female_absent_genes_hits.bed > ~/Documents/stage_mbelari/results/duplications/2018-07-26-Blast_female_absent_genes_hits.sorted.bed
...
bedtools map -o count -g ~/Documents/stage_mbelari/results/coverage_analysis/2018-06-21-Mbelari_hybrid_genome_sizes.txt -a ~/Documents/stage_mbelari/results/duplications/2018-07-26-Blast_female_absent_genes_hits.sorted.bed -b ~/Documents/stage_mbelari/results/coverage_analysis/2018-06-12-MRDR5_vs_Hybrid_assembly.sorted.filtered.bam_to_bed.bed > ~/Documents/stage_mbelari/results/duplications/2018-07-26-Blast_female_absent_genes_hits_MRDR5_counts.txt &

bedtools map -o count -g ~/Documents/stage_mbelari/results/coverage_analysis/2018-06-21-Mbelari_hybrid_genome_sizes.txt -a ~/Documents/stage_mbelari/results/duplications/2018-07-26-Blast_female_absent_genes_hits.sorted.bed -b ~/Documents/stage_mbelari/results/coverage_analysis/2018-06-12-MRDR6_vs_Hybrid_assembly.sorted.filtered.bam_to_bed.bed > ~/Documents/stage_mbelari/results/duplications/2018-07-26-Blast_female_absent_genes_hits_MRDR6_counts.txt &
