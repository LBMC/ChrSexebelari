...
samtools mpileup -t DP,AD,ADF,ADR,SP,INFO/AD,INFO/ADF,INFO/ADR -ABQ0 -L 100000 -uf results/RepeatMaskerfinal_assembly.fasta.soft.masked results/SNPs/ | bcftools call -mv --output-type z -p 0.1 -o results/SNPS/2017_09_20_MRDR5_trim_Mbelari_mapped_rmdup.vcf.gz &&\
